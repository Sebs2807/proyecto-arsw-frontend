...
const NotificationsFloat: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    globalThis.addEventListener("calendar:updated", onUpdate as EventListener);
    return () => globalThis.removeEventListener("calendar:updated", onUpdate as EventListener);
  }, [fetchPending]);
